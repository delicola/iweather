package njupt.iot.hobert.iweather;
...
import njupt.iot.hobert.iweather.util.Utility;
...
public class WeatherActivity extends AppCompatActivity {
    ...
    public void requestWeather(final String weatherId) {
        String weatherUrl = "https://free-api.heweather.com/s6/weather?location=" + weatherId + "&key=b844972b249244019f2afb19e1f3c889";
        Log.d("weather666", "requestWeather: "+weatherId);
        ...
        HttpUtil.sendOkHttpRequest(weatherUrl, new Callback() {
            ...
            public void onResponse(Call call, Response response) throws IOException {
                ...
                //  Log.d("weatherstatus", "requestWeather: "+weather.status);
                Log.d("resposetext", " text"+responseText);
